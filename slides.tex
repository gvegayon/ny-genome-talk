...
\date{NY Genome Center\\March 9, 2021}
...
\begin{frame}[c]
	...
	\end{minipage}\hfill
	\uncover<3->{\begin{minipage}[t]{.50\linewidth}
	    \vfill
	    \begin{itemize}
...
\includegraphics[height=2cm]{aphylo-data-2.png}
    \begin{itemize}
        \item Further study properties of the model (bias/power/accuracy).
        \item Start working on extensions.
    \end{itemize}
}
\end{frame}
