...
\textcolor{uscgold}{
\Large {\bf Part 1: Bayesian parameter estimation for automatic annotation of gene functions using observational data and phylogenetic trees} \vskip0.25em
...
\begin{frame}[c]
	...
	\begin{figure}
	\includegraphics[width=.8\linewidth]{fig/trace-gain-loss.png}
	\caption{MCMC Trace of the functional gain and loss parameters. The true population parameters are:\linebreak$(\theta_{gain0}, \theta_{gain1}) = (2.0, 1.5)$ and $(\theta_{loss0}, \theta_{loss1}) = (-2.0, -1.5)$}
	\end{figure}
\end{frame}
...
\begin{frame}[c]
	...
	\begin{figure}
		\includegraphics[width=.8\linewidth]{fig/trace-one-root.png}
...
\begin{figure}
	\centering
	\includegraphics[width=.45\linewidth]{fig/aphylo-sim-study.pdf}
